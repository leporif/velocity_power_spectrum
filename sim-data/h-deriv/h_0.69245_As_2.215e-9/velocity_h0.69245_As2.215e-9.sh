...
srun -N 4 -n 16 --cpus-per-task=72 -C gpu -A go25 --time=00:20:00 --partition=normal --hint=exclusive --cpu-bind=socket ./gpu-bind.sh ./gevolution -n 4 -m 4 -s /capstor/scratch/cscs/leporif/VelocityField/gevolution-2.0/output/grad-1/h-deriv/Ngrid512_Lbox128/fixed_As//h_0.69245_As_2.215e-9/settings.ini
'
